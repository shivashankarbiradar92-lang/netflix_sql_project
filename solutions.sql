...
-- Categorize the content based on the presence of keywords like 'kill' or 'violence' in the description field. Label the content containing these keywords as 'bad' and all other content as 'good'. Count how many items fall into each of these categories
